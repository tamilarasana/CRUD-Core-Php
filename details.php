      ...
      <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css">
        ...
        <nav class="navbar navbar-default">
                  <div class="container-fluid">
                     ...
                     <!-- <li> <a class="btn btn-danger" href="index.php">Back</a></li> -->
                     <?php
                      session_start();
          ...
          <div class="row">
            <div class="col-md-3">
                <form class="needs-validation" name="myForm" action="details.php" method="post" autocomplete="off"  enctype ="multipart/form-data"  novalidate>
                    ...
                    <div class="form-group">
                        <label>Name</label>
                        <input type="text" name="name" placeholder="Name"   id="name" class="form-control" maxlength="15" minlength="4" pattern="^[a-zA-Z0]*$" required>
                    ...
                    <div class="form-group">
                        <label>Year</label>
                        <input type="text" name="year" placeholder="Year" class="form-control" maxlength="1" minlength="1" pattern="^[0-9_.-]*$" required>
                   ...
                   <div class="form-group">                               
                    ...
                    <div class="form-group">
                            ...
                            <div class="invalid-feedback">Please eSelect Your Department.</div>                           
                        </div>                    
                    <div class="form-group">
                        <label>Phone</label>
